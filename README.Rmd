...
The data from each sensor is saved separate csv file, each with manufacturer-specific columns.
...
The `ss_compile_deployment_data()` function reads in the log and the data for each sensor and exports a single data frame.
```{r}
